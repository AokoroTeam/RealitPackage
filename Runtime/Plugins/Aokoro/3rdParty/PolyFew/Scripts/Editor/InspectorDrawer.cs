...
#pragma warning disable
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.64</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.64</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                                    ...
                                    foreach(PolyFew polyfew in polyfews)
                                    {
                                        ...
                                        */
                                        ...
                                        if (dataContainer != null)
                                        {
                                            ...
                                            {
                                                UtilityServices.RestoreMeshesFromPairs(dataContainer.objectMeshPairs);
                                                dataContainer.triangleCount = UtilityServices.CountTriangles(dataContainer.considerChildren, dataContainer.objectMeshPairs, polyfewGameObject);
